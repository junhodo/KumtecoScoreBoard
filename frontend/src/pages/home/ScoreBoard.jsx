                                ...
                                <tr>
                                    ...
                                    {Object.keys(solved[el]).map((e) => {
                                        return (
                                            ...
                                            :
                                            solved[el][e] < 4 ?
                                            <td keys={+el+1 + e} className="danger">
                                                {solved[el][e]} / 10
                                                <ProgressBar animated  variant="danger" now={solved[el][e]*10}></ProgressBar>
                                            </td> 
                                            :
                                            solved[el][e] < 7 ?
                                            <td keys={+el+1 + e} className="yet">
                                                {solved[el][e]} / 10
                                                <ProgressBar variant="warning" now={solved[el][e]*10}></ProgressBar>
                                            </td> 
                                            :
                                            solved[el][e] < 10 ?
                                            <td keys={+el+1 + e} className="yet">
                                                {solved[el][e]} / 10
                                                <ProgressBar variant="success" now={solved[el][e]*10}></ProgressBar>
                                            </td> 
                                            :
                                            <td keys={+el+1 + e} className="solved">
                                                {solved[el][e]} / 10
                                                <ProgressBar animated  variant="success" now={solved[el][e]*10}></ProgressBar>
                                            </td>
                                        )
                                    })}
                                </tr>
